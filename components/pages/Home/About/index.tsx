  ...
  return (
    <section id='#about' className='section-gap'>
      <div className="container mx-auto">
          <div className="flex flex-col lg:justify-between lg:flex-row items-center flex-reverse w-[90%] mx-auto">
            ...
            <div className="w-6/12 flex justify-end relative">
                ...
                <img src="/images/gallery/gallery-2.jpg" alt="about" className='absolute h-[250px] bottom-6 left-20'/>
            </div>
          </div>
        </div>
      </section>
